...
import in.hopscotch.dwguice.jms.excception.MessageQueueExceptionHandler;
import io.dropwizard.lifecycle.Managed;

public abstract class MessageQueueReceiverHandler<T> implements Managed, Runnable {
    ...
    public MessageQueueReceiverHandler(
            ...
            MessageQueueBaseExceptionHandler exceptionHandler,
